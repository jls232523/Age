...
dataPath = input("Where is the data?")
modelPath = input("Where is the model?")
labelPath = input("Where is the labels?")
plotPath = "plot.png"
...
model = cnnModel.build(imgWidth=IMAGE_DIMS[1], imgHeight=IMAGE_DIMS[0],
                            channel=IMAGE_DIMS[2], ageGrps=len(lb.classes_))
